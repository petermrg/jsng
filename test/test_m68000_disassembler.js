...
describe('m68000', function () {
    ...
    describe('#disassemble()', function () {
        ...
        it('disassembles NEGX', function() {
            dasm.memory.setInt16(5, bin('0100 0000 00 000 111'));
            assert.equal(dasm.disassemble(5), 'NEGX D7');

            dasm.memory.setInt16(5, bin('0100 0000 01 000 110'));
            assert.equal(dasm.disassemble(5), 'NEGX.W D6');

            dasm.memory.setInt16(5, bin('0100 0000 10 000 101'));
        ...
        it('disassembles ORI', function() {
            dasm.memory.setInt32(3, bin('0000 000 000 000 101  00000000 01111111'));
            assert.equal(dasm.disassemble(3), 'ORI #127,D5');

            dasm.memory.setInt32(3, bin('0000 000 001 000 101  00000000 01111111'));
            assert.equal(dasm.disassemble(3), 'ORI.W #127,D5');

            dasm.memory.setInt16(3, bin('0000 000 010 000 101'));
            dasm.memory.setInt32(5, bin('11111111 11111111 11111111 11111111'));
        ...
        it('disassembles SUBA', function() {
            dasm.memory.setInt16(3, bin('1001 101 011 000 110'));
            assert.equal(dasm.disassemble(3), 'SUBA.W D6,D5');

            dasm.memory.setInt16(3, bin('1001 101 111 000 110'));
            assert.equal(dasm.disassemble(3), 'SUBA.L D6,D5');

            dasm.memory.setInt16(3, bin('1001 101 011 010 110'));
            assert.equal(dasm.disassemble(3), 'SUBA.W (A6),D5');

            dasm.memory.setInt16(3, bin('1001 101 111 010 110'));
        ...
        it('disassembles TRAP', function() {
            dasm.memory.setInt16(3, bin('0100 11100100 0111'));
            assert.equal(dasm.disassemble(3), 'TRAP #7');
        });

        it('disassembles TRAPV', function() {
            dasm.memory.setInt16(3, bin('0100111001110110'));
        ...
        it('disassembles STOP', function() {
            dasm.memory.setInt16(2, bin('0100111001110010'));
            assert.equal(dasm.disassemble(2), 'STOP');
        });
